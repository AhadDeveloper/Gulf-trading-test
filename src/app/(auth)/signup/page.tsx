...
// --- Sub-component to handle the form logic ---
function SignupForm() {
...
export default function Signup() {
  return (
    // This Suspense boundary is now outside the component using useSearchParams
    <Suspense
      fallback={<div className="p-10 text-center">Loading Registration...</div>}
    >
      <SignupForm />
    </Suspense>
  );
